...
import com.bdd.web.step.AseaStep;
...
public class AseaStepDefinition {
    ...
    @Y("^selecciono la cantidad del producto \"([^\"]*)\"$")
    public void seleccionoLaCantidadDelProducto(String cant) throws Throwable {
...
//    }
    ...
    @Y("^selecciono la opcion \"([^\"]*)\"$")
    public void seleccionoLaOpcion(String opcion) throws Throwable {
